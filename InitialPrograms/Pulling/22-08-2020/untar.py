...
toTar = ['ContactStates**.txt','Filament**.vtk','IntSpecie1**.vtk','IntSpecie2**.vtk','MotorSpecie1**.vtk','MotorSpecie2**.vtk','MTPlusEnd**.vtk','ds**.csv']
tarF = ['ContactStates.tar','Filament.tar','IntSpecie1.tar','IntSpecie2.tar','MotorSpecie1.tar','MotorSpecie2.tar','MTPlusEnd.tar','ds.tar']
grp = []
