...
files = ['MotilityAssayActin2MotorsParameters_v06a.f90', 'mt.f90', 'MotilityAssayActin2MotorsConfinements_v02a.f90', 'MotilityAssayActin2MotorsForce_v01a.f90', 'MotilityAssayActin2MotorsFunc_v01k.f90', 'MotilityAssayActin2MotorsOutput_v01d.f90', 'MotilityAssayActin2MotorsMain_v011m.f90', 'analysis.py', 'film1.py', 'film2.py', 'tar.py', 'untar.py']
...
while simulation_runs > 0:
    ...
    subprocess.call("ifort MotilityAssayActin2MotorsParameters_v06a.f90 mt.f90 MotilityAssayActin2MotorsConfinements_v02a.f90 MotilityAssayActin2MotorsForce_v01a.f90 MotilityAssayActin2MotorsFunc_v01k.f90 MotilityAssayActin2MotorsOutput_v01d.f90 MotilityAssayActin2MotorsMain_v011m.f90", shell=True)
