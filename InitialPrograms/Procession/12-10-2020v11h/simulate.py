...
files = ['MotilityAssayActin2MotorsParameters_v06a.f90', 'mt.f90', 'MotilityAssayActin2MotorsConfinements_v02a.f90', 'MotilityAssayActin2MotorsForce_v01a.f90', 'MotilityAssayActin2MotorsFunc_v01c.f90', 'MotilityAssayActin2MotorsOutput_v01b.f90', 'MotilityAssayActin2MotorsMain_v011h.f90', 'analysis.py', 'film1.py', 'film2.py', 'tar.py', 'untar.py']
...
while simulation_runs > 0:
    ...
    for i, line in enumerate(fileinput.input(param_file, inplace=1)):
        sys.stdout.write(line.replace('AreaRenewDiv = 2E4', 'AreaRenewDiv = '+str( int( (outDt)/float(Dt) ) ) ))
    #print ("\n=> Param. file in %s successfully updated." % new_dir)
    #print ("\n=> Simulation program started!: %s" % new_dir)
    subprocess.call("ifort MotilityAssayActin2MotorsParameters_v06a.f90 mt.f90 MotilityAssayActin2MotorsConfinements_v02a.f90 MotilityAssayActin2MotorsForce_v01a.f90 MotilityAssayActin2MotorsFunc_v01c.f90 MotilityAssayActin2MotorsOutput_v01b.f90 MotilityAssayActin2MotorsMain_v011h.f90", shell=True)
