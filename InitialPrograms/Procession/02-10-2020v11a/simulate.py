...
'MotilityAssayActin2MotorsMain_v011a.f90', 'analysis.py', 'film1.py', 'film2.py', 'tar.py', 'untar.py']
...
while simulation_runs > 0:
    ...
    subprocess.call("ifort mt.f90 MotilityAssayActin2MotorsParameters_v5.f90 MotilityAssayConfinements_v1.f90 MotilityAssaySubstrateDeformation_v2.f90 MotilityAssayForceForceFunctions_v3.f90 MotilityAssayActin2MotorsMain_v011a.f90", shell=True)
